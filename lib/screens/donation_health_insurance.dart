...
class DonationHealthInsurancePage extends StatefulWidget {
  static const String routeName = '/donation_health_insurance';

  const DonationHealthInsurancePage({super.key});

  @override
  _DonationHealthInsurancePageState createState() =>
      _DonationHealthInsurancePageState();
}

class _DonationHealthInsurancePageState
    extends State<DonationHealthInsurancePage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Donate for Health Insurance', style: TextStyle(color: Colors.white)),
        ...
        child: Form(
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              SizedBox(height: 30),
              Text(
                'Donation Amount for Health Insurance',
                style: TextStyle(
              ...
              SizedBox(height: 30),
              Text(
                'Offline Donation Instructions for Health Insurance',
                style: TextStyle(
                  fontWeight: FontWeight.w500,
                  color: Color(0xFF223B6A),
                  fontSize: 16,
              ...
              ElevatedButton(
                  ...
                  if (_formKey.currentState!.validate()) {
                    ...
                    showDialog(
                      ...
                      builder: (BuildContext context) {
                        return AlertDialog(
                          title: Text('Health Insurance Donation Information'),
                          content: Text(
                              'Thank you, $firstName $lastName, for your generous donation to help provide health insurance to those in need. We will contact you shortly.'),
                          actions: [
                            TextButton(
                              onPressed: () {
                ...
                child: Text('Make Health Insurance Donation'),
              ),
            ],
          ),
        ),
