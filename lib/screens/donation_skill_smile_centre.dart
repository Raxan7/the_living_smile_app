...
class DonationSkillSmileCentrePage extends StatefulWidget {
  static const String routeName = '/donation_skill_smile_centre';

  const DonationSkillSmileCentrePage({super.key});

  @override
  _DonationSkillSmileCentrePageState createState() =>
      _DonationSkillSmileCentrePageState();
}

class _DonationSkillSmileCentrePageState
    extends State<DonationSkillSmileCentrePage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Donate to Skill Smile Centre', style: TextStyle(color: Colors.white)),
        ...
        child: Form(
          ...
          child: Column(
            ...
            children: <Widget>[
              Center(
                child: Text(
                  'Make a Donation to Skill Smile Centre',
                  style: TextStyle(
                    fontSize: 32,
                    ...
                    showDialog(
                      ...
                      builder: (BuildContext context) {
                        return AlertDialog(
                          ...
                          content: Text(
                              'Thank you, $firstName $lastName, for your donation to Skill Smile Centre. We will contact you shortly.'),
                          actions: [
                            TextButton(
                              onPressed: () {
